...
public:
    ...
    rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_activate(
        ...
        // 这里调用父类 LifecycleNode 的 on_activate 方法，内部调用了 pub_str_->on_activate()，用于告知下游，上游发布节点已经激活
    ...
    rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_deactivate(
        const rclcpp_lifecycle::State& pre_state) {
        // 这里调用父类 LifecycleNode 的 on_deactivate 方法，内部调用了 pub_str_->on_deactivate()，用于告知下游，上游发布节点已经关闭
